...
import { DeployRegistries } from "../../script/deployment/04_DeployRegistries.s.sol";
...
contract DeployReceiptTokenTest is Test {
    ...
    function test_deploy_receiptToken() public view {
        ...
        assertEq(manager.receiptTokenFactory(), address(receiptTokenFactory), "ReceiptTokenFactory in Manager is wrong");
    }
}
