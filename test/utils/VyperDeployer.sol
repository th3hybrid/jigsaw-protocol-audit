...
contract VyperDeployer {
    ...
    ///@param fileName - The file name of the Vyper contract. For example, the file name for "SimpleStore.vy" is
    /// "SimpleStore"
    ...
    function deployContract(string memory fileName) public returns (address) {
        ...
        cmds[0] = "vyper";
        cmds[1] = string.concat("contracts/vyper/", fileName, ".vy");
    ...
    ///@notice Compiles a Vyper contract with constructor arguments and returns the address that the contract was
    /// deployeod to
    ///@notice If deployment fails, an error will be thrown
    ///@param fileName - The file name of the Vyper contract. For example, the file name for "SimpleStore.vy" is
    /// "SimpleStore"
