...
interface IStrategy {
     ...
     * @return tokenInAmount The returned token in amount.
     * @return yieldAmount The amount of yield generated by the user beyond their initial investment.
     */
    function withdraw(
        uint256 _shares,
        address _recipient,
        address _asset,
        bytes calldata _data
    ) external returns (uint256 assetAmount, uint256 tokenInAmount, int256 yieldAmount);
